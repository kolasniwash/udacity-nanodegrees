...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type=int, default=2, metavar='IN',
                       help='input dimensions of data (default 2)')
    parser.add_argument('--hidden_dim', type=int, default=32, metavar='H',
                       help='dimensions of the hidden layers (default 32)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='OUT',
                       help='dimensions of output layer (default 1 for binary classification)')
